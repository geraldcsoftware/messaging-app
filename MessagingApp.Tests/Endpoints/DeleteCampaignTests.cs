...
public class DeleteCampaignTests: IClassFixture<ApplicationFactory>
{
    private readonly ApplicationFactory _factory;

    public DeleteCampaignTests(ApplicationFactory factory)
    {
        _factory = factory;
    }

    [Fact]
    public async Task DeleteCampaignById_WhenCampaignExists_ReturnsOkWithCampaignDetails()
    {
        // Arrange
        ...
        var subsequentResponse = await client.DeleteAsync(url);
        // Assert
        response.StatusCode.Should().Be(HttpStatusCode.OK);
        subsequentResponse.StatusCode.Should().Be(HttpStatusCode.NotFound);
     ...
     [Fact]
    public async Task DeleteCampaignById_WhenCampaignDoesntExist_ReturnsNotFound()
    {
        // Arrange
        var clientId = Guid.NewGuid().ToString();
        var campaignId = Guid.NewGuid().ToString();
